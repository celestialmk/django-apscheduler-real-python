...
class Command(BaseCommand):
    ...
    def handle(self, *args: Any, **options: Any) -> str | None:
        ...
        scheduler.add_job(
            ...
            ), #Midnight Monday before start of new week
